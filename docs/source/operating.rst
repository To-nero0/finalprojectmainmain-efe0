[finalprojectmainmain-efe0] Operating Details
====================================

Generated On: 2024-11-15 02:35:28 UTC
...
.. important::
   ...
   **not be valid if your [finalprojectmainmain-efe0] container is NOT running**.

.. tip::
   You must have your [finalprojectmainmain-efe0] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/To-nero0/TMLRaspberry/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/To-nero0/TMLRaspberry  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33835  \-\-env VIPERVIZPORT=57825  \-\-env GITUSERNAME='To-nero0'  \-\-env DOCKERUSERNAME='anthopadua'  \-\-env MQTTUSERNAME='Anthopadua'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:57825/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:57825/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   anthopadua/finalprojectmainmain-efe0-amd64 (https://hub.docker.com/r/anthopadua/finalprojectmainmain-efe0-amd64)
...
.. important::
   docker run -d -p 40367:40367 -p 36797:36797 -p 58689:58689 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=finalprojectmainmain-efe0 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalprojectmainmain-efe0 \-\-env GITUSERNAME=To-nero0  \-\-env GITREPOURL=https://github.com/To-nero0/TMLRaspberry \-\-env SOLUTIONEXTERNALPORT=40367  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=36797  \-\-env SOLUTIONVIPERVIZPORT=58689 \-\-env DOCKERUSERNAME='anthopadua' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=33835 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=57825 \-\-env MQTTUSERNAME='Anthopadua' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  anthopadua/finalprojectmainmain-efe0-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - anthopadua/finalprojectmainmain-efe0-amd64
...
[finalprojectmainmain-efe0] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/To-nero0/TMLRaspberry/tree/main/tml-airflow/dags/tml-solutions/finalprojectmainmain-efe0
...
.. important::
   https://finalprojectmainmain-efe0.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-finalprojectmainmain-efe0
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=40367, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45659, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36737, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36459, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43767, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45245, HPDEHOST=127.0.1.1, HPDEPORT=36059, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39661

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7335-finalprojectmainmain-efe0,solution_preprocessing_ai_mqtt_dag-finalprojectmainmain-efe0, python-preprocess-9332-finalprojectmainmain-efe0,solution_preprocessing_ai_mqtt_dag-finalprojectmainmain-efe0, python-ai-535-finalprojectmainmain-efe0,solution_preprocessing_ai_mqtt_dag-finalprojectmainmain-efe0, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
